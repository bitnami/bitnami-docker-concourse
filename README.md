...
* [`7`, `7-debian-11`, `7.8.2`, `7.8.2-debian-11-r3`, `latest` (7/debian-11/Dockerfile)](https://github.com/bitnami/bitnami-docker-concourse/blob/7.8.2-debian-11-r3/7/debian-11/Dockerfile)
...
```console
$ docker build -t bitnami/concourse:latest 'https://github.com/bitnami/bitnami-docker-concourse.git#master:7/debian-11'
```
